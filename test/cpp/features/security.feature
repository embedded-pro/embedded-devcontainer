Feature: Security
  ...
  Rule: Build provenance
    embedded-devcontainer *SHALL* include build provenance as specified in [SLSA v1.0 Build L3](https://slsa.dev/spec/v1.0/levels).
  ...
  Rule: Software Bill of Materials (SBOM)
    embedded-devcontainer *SHOULD* provide a Software Bill of Materials (SBOM) for its released container images.
