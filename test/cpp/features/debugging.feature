Feature: Debugging
  ...
  Rule: Debugging support
    embedded-devcontainer *SHALL* provide debugging support for the primary programming language(s) used within the container.
  ...
  Rule: Upload firmware to micro-controller
    embedded-devcontainer *MAY* provide tools to upload compiled firmware to a connected micro-controller.
