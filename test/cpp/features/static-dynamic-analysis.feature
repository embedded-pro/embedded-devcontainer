Feature: Static and dynamic analysis
  ...
  Rule: Code formatting
    embedded-devcontainer *MAY* provide code formatting tools for the primary programming language(s) used within the container.
  ...
  Rule: Static analysis
    embedded-devcontainer *MAY* provide static analysis tools for the primary programming language(s) used within the container.
  ...
  Rule: Coverage analysis
    embedded-devcontainer *SHOULD* provide code coverage analysis tools for the primary programming language(s) used within the container.
  ...
  Rule: Mutation testing
    embedded-devcontainer *MAY* provide mutation testing tools for the primary programming language(s) used within the container.
  ...
  Rule: Fuzz testing
    embedded-devcontainer *MAY* provide fuzz testing tools for the primary programming language(s) used within the container.
